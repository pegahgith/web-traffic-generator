<?php
/*
Plugin Name: افزودن کوئری های مرتبط
Plugin URI: https://ehm.ir
Descriptiom:  افزودن کوئری های ورودی موتورهای جستجوگر به انتهای مقالات به همراه ابزارک
Author: ابراهیم حنفی
Versio: 1.0
...
function RCT12_stt2_admin_print_title(){
	...
	<div class = "wrap">
		...
		<h2>افزودن کوئری های مرتبط</h2>
		<h4>معرفی توسط <a href="https://ehm.ir" target="_blank">مسترسئوکار</a></h4>
    <?php 
}
/**
...
function RCT12_stt2_admin_print_header(){
	...
	?>
		<div><p>        اگر فکر میکنید این افزونه توانسته کمک زیادی به شما بکند لطفا از برنامه نویس این افزونه حمایت کنید
		<a href="<?php echo $baseurl.'&donate'; ?>">حمایت مالی</a></div>
		<p><a href="<?php echo $baseurl; ?>">تنظیمات</a> | <a href="<?php echo get_bloginfo('url').'/wp-admin/widgets.php'; ?>">ابزارک ها</a> | <a href="<?php echo $baseurl.'&stt2_help=1'; ?>">آموزش</a> | <strong>آمار کامل:</strong> <a href="<?php echo $baseurl.'&stats=1&count=50'; ?>">50</a>, 
		...
		<a href="<?php echo $baseurl.'&stt2_no_traffics=0'; ?>">مقالات بدون ورودی موتور جستجو</a></strong> ( <a href="<?php echo $baseurl.'&stt2_no_traffics=1'; ?>">فقط آدرس</a> )</p>
    <?php
}
/*
		...
		<div class="metabox-holder">
			<div class="meta-box-sortables ui-sortable">    		
				<div id="stt2settings" class="postbox">
					...
					<h3 class="hndle">
						<span>تنظیمات کلی (ابزارک ها تنظیمات شخصی خود را دارند)</span></h3>
					<div class="inside">
						<form id="stt2-options" method="post" action="">
							<table class="stt2-table">
								...
								<tr>
									<td width="350px">
										<label>             بیشترین تعداد ورودی زیر مقالات:
										</label>
									</td>
									<td>
								...
								<tr>
									<td>
										<label>             کد html بالای لیست کیوردهای ورودی:
										</label>
									</td>
									<td>
								...
								<tr>
									<td>
										<label>             متن و کد html قبل و بعد از لیست:
										</label>
									</td>
									<td>         قبل:
										<input type = "text" name = "before_list" value = "<?php echo htmlspecialchars(stripslashes($options['before_list'])); ?>" size="10"/>         &nbsp;&nbsp;بعد:
										<input type = "text" name = "after_list" value = "<?php echo htmlspecialchars(stripslashes($options['after_list'])); ?>" size="10"/>
									</td>
								</tr>
								<tr>
									<td>
										<label>             متن یا کد html قبل و بعد از هر کیورد:
										</label>
									</td>
									<td>         قبل:
										<input type = "text" name = "before_keyword" value = "<?php echo htmlspecialchars(stripslashes($options['before_keyword'])); ?>" size="10"/>         &nbsp;&nbsp;بعد:
										<input type = "text" name = "after_keyword" value = "<?php echo htmlspecialchars(stripslashes($options['after_keyword'])); ?>" size="10"/>
									</td>
								</tr>
								<tr>
									<td style="vertical-align: top;">
										<label>             آیا کلمات را لینک بکنم:
										</label>
									</td>
									<td>
										<Input type="radio" name="auto_link" value="1" <?php if ( 1 == $options['auto_link'] ){ echo 'checked'; } ;?> />         بله، به خود مطلب لینک شود<br />
										<Input type="radio" name="auto_link" value="2" <?php if ( 2 == $options['auto_link'] ){ echo 'checked'; } ;?> />         بله،  به صفحه جستجوی وردپرس لینک شود (توصیه نمی شود)<br />
										<Input type="radio" name="auto_link"  value="0" <?php if ( 0 == $options['auto_link'] ){ echo 'checked'; } ;?> />         خیر
									</td>
								</tr>
								<tr>
									<td>
										<label>             نمایش تعداد جلوی هر کلمه ورودی:
										</label>
									</td>
									<td>
										<Input type="radio" name="show_count" value="1" <?php if ( 1 == $options['show_count'] ){ echo 'checked'; } ;?> />         بله&nbsp;&nbsp;
										<Input type="radio" name="show_count"  value="0" <?php if ( 0 == $options['show_count'] ){ echo 'checked'; } ;?> />         خیر
									</td>
								</tr>
								<tr>
									<td>
										<label>             افزودن خودکار لیست به انتهای مقالات:
										</label>
									</td>
									<td>
										<Input type="radio" name="auto_add" value="1" <?php if ( 1 == $options['auto_add'] ){ echo 'checked'; } ;?> />         بله&nbsp;&nbsp;
										<Input type="radio" name="auto_add" value="0" <?php if ( 0 == $options['auto_add'] ){ echo 'checked'; } ;?> />         خیر
									</td>
								</tr>
								<tr>
									<td>
										<label>             آیا ورودی های مقالات را برچسب هم بکنم:
										</label>
									</td>
									<td>
										<Input type="radio" name="auto_tag" value="1" <?php if ( 1 == get_option('RCT12_stt2_auto_tag') ){ echo 'checked'; } ;?> />         بله&nbsp;&nbsp;
										<Input type="radio" name="auto_tag" value="0" <?php if ( 0 == get_option('RCT12_stt2_auto_tag') ){ echo 'checked'; } ;?> />         خیر
									</td>
								</tr>
								<tr>
									<td>
										<label>             پاکسازی خودکار کلمات بدون ساتفاده بعد از :
										</label>
									</td>
									<td>
										<input type = "text" name = "auto_cleanup" value = "<?php echo $auto_cleanup; ?>" size="10"/> روز ( پیش فرض: 90 روز )
									</td>
								</tr>								
								<tr>
									<td valign="top" style="padding-top:10px;">
										<label>این کلمات را ذخیره نکن و نشان نده:</label>
									</td>
									<td>
								...
								<tr>
									<td>
										<label>             پروموت کردن مقالات قبلی که ورودی موتور جستجو ندارند:
										</label>
									</td>
									<td>
										<Input type="radio" name="promote_old_post" value="1" <?php if ( 1 == $promote_old_post ){ echo 'checked'; } ;?> />         بله&nbsp;&nbsp;
										<Input type="radio" name="promote_old_post" value="0" <?php if ( 0 == $promote_old_post ){ echo 'checked'; } ;?> />         خیر
									</td>
								</tr>								
								<tr>
									<td colspan=2>
										...
										<span class="submit" style="margin-top:14px;">
											<input class="button-primary" type = "submit" name="submit" value="ذخیره تغییرات" />
										</span>
									</td>
								</tr>
							</table>
		...
		<div class="metabox-holder">
			<div class="meta-box-sortables ui-sortable">
				<div id="stt2-donate" class="postbox">
					...
					<h3 class="hndle">
						<span>لطفا از ناشر حمایت کنید (واقعا کارش درسته 😁):
						</span></h3>
					<div class="inside">
				...
				<div id="stt2-mainkeywords" class="postbox">
					...
					<h3 class="hndle">
						<span>بیشترین ورودی ها به صفحه اول:
						</span></h3>
					<div class="inside">
						<div class="frame list">
  ...
  <div class="metabox-holder">
       <div id="stt2-copyright" class="postbox">
        <div class="inside">
		  ...
		  <p><strong>این افزونه توسط <a href="https://ehm.ir" target="_blank">مسترسئوکار</a></strong> معرفی شده است.</p>
		  <p>Copyright &copy; 2010-2023 by Ebrahim Hanafi.</p> </div>
        </div>
     </div>
  </div>
</div>
...
function RCT12_stt2_register_2($form_name='frm2',$name,$email) {
	...
	?>
	 ...
	 <table width="640" cellspacing="1" style="border:1px solid #e9e9e9; padding: 0 14px 14px;">
	   ...
	   <tr><td>&nbsp;</td></tr>
	   <tr><td>5. If you still got problems, please <a href="https://ehm.ir" target="_blank">contact us</a></strong> about it and we will get to you ASAP.</td></tr>
	 </table>
	 </center>		
	<p>&nbsp;</p>
	</div>
...
?>
	...
	<p>
	<input src="https://www.paypal.com/en_US/GB/i/btn/btn_donateCC_LG.gif" name="submit" alt="از ناشر افزونه حمایت کنید" style="border: medium none; background: none repeat scroll 0% 0% transparent;" border="0" type="image" />
